...
const SUPPORT_EMAIL = process.env.NEXT_PUBLIC_SUPPORT_EMAIL || brand.contact.supportEmail;
      ...
      <article className="bg-white">
        ...
        {s.orders === 0 ? (
          ...
          <>
            ...
            <Section title="Collection sales"><Table rows={report.collections} labelHeader="Collection" /></Section>
            ...
            <footer className="mt-8 border-t border-ink/15 pt-3 text-[9.5px] leading-relaxed text-ink/50">
              <p>
                Product, category and collection totals are line-item values and add up to the items subtotal, not the net —
