...
export default function StockAdjustButton({ variantId, productName }: { variantId: string; productName: string }) {
  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/admin/inventory/adjust", {
        ...
        body: JSON.stringify({ variantId, change: qty * direction, reason: reason.trim() }),
      });
