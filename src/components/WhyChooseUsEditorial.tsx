  ...
  return (
    <section className="container-px mx-auto section-py" style={backgroundColor ? { backgroundColor } : undefined}>
      <div className="grid md:grid-cols-[1fr_1.2fr] gap-12 items-center">
        ...
        <div>
          <p className="text-xs uppercase tracking-[0.2em] text-rose-gold-text font-semibold mb-4">{subtitle || "Why Shop With Us"}</p>
          <h2 className="font-display text-3xl md:text-4xl font-semibold mb-8 leading-tight">
            {title || "Considered clothing, delivered the way it should be."}
          </h2>
