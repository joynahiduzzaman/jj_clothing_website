...
const SLIDES = [
  ...
  "https://images.unsplash.com/photo-1445205170230-053b83016050?auto=format&fit=crop&w=2400&q=85",
  "https://images.unsplash.com/photo-1487222477894-8943e31ef7b2?auto=format&fit=crop&w=2400&q=85",
];
...
function HeroCopy({
  ...
  return (
    <>
      <HeroEyebrow>New Season · Everyday Essentials</HeroEyebrow>
...
function heroStats(dict: Dictionary, brandCount: number) {
  return [
    { srLabel: "Quality guarantee", value: "100%", Icon: ShieldCheck, label: "Original Products" },
    { srLabel: "Collections available", value: `${brandCount}+`, Icon: null, label: dict.home.statBrands },
