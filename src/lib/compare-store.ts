...
// /compare page loads full detail (material, fit, care instructions, variants,
// etc.) from the API by id, so this never goes stale and never needs to store
// much.
