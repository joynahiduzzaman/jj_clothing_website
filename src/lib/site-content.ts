...
// Placeholder business details — replace every one of these from Admin → Site
// Content → Business Info before going live. Deliberately generic rather than
...
export const BUSINESS_DEFAULTS: Record<string, string> = {
  ...
  hoursPrimary: "Open 7 days a week",
  hoursSecondary: "10am – 8pm",
